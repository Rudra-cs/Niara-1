...
import com.NiaraFoodJoint.niara.Model.CreateOrderInfo;
import com.NiaraFoodJoint.niara.Adapters.CustomerInfoAdapter;
...
//        objBgThread.start();
    ...
    public void onRemoveClicked(CustomerInfo address,int position) {
        ...
        removeCartItems.enqueue(new Callback<Void>() {
            ...
            public void onResponse(Call<Void> call, Response<Void> response) {
                if (response.isSuccessful()){
                    Toast.makeText(PaymentActivity.this, "Removed Successfully!!",Toast.LENGTH_SHORT).show();
                    loadAddress();
                }
            }
